...
void main() {
  ...
  test('convert 1 btc to usd', () {
    double result = BtcConversion.btcToUsd(1);

    expect(result, 61909.20);
  });

  test('convert 2 btc to usd', () {
    double result = BtcConversion.btcToUsd(2);

    expect(result, 123818.40);
  });

  test('convert 61,909.20 usd to btc', () {
    double result = BtcConversion.usdToBtc(61909.20);

    expect(result, 1.0);
  });

  test('convert 123,818.40 usd to btc', () {
    double result = BtcConversion.usdToBtc(123818.40);
